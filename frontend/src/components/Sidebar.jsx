  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <span className="logo-text">Radian<span>HRMS</span></span>
      </div>
      ...
      <nav className="sidebar-nav">
        ...
        {isManager() && (
          <NavLink to="/leave-approvals" className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`}>
            {icons.approvals} Leave Approvals
          </NavLink>
        )}
